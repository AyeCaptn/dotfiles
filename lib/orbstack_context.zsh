...
spaceship_orbstack_context() {
    ...
    if [[ -n $DOCKER_MACHINE_NAME ]]; then
        ...
        docker_remote_context=$(docker context ls --format '{{if .Current}}{{if and (ne .Name "default") (ne .Name "desktop-linux") (ne .Name "colima") (ne .Name "orbstack")}}{{.Name}}{{end}}{{end}}' 2>/dev/null)
        [[ $? -ne 0 ]] && return
